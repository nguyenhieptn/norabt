...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        historyTime = startTime - 20 * 86400 * 1000
    ...
    def getStartTime(self):
            ...
            lastData = list(self.busdModel.collection.find({BusdModel.symbol: self.symbol}).sort(BusdModel.timestamp, -1).limit(1))
            if(len(lastData) > 0):
