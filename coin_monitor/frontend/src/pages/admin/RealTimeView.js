...
import Realtime from '../../models/admin/Realtime';
...
class RealTimeView extends Component {
    ...
    constructor(props) {
        ...
        this.realTimeModel = new Realtime()
    ...
    updateIframe(){
        ...
        var chartName = `/public/plot/${account}_${symbol}_${date}.html?id=${time}`
...
// RealTimeView.contextType = ThemeContext;
