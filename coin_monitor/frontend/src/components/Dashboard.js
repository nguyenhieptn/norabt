    ...
    const countryTemplate = (data, props) => {
        return (
            <>
                ...
                <span className="ml-2" style={{ verticalAlign: 'middle' }}>{data.country.name}</span>
            </>
        )
    }
        ...
        return (
            <div className="card mr-4">
                <div className="customer-item-content">
                    <div className="mb-6">
                        <img src={'public/assets/layout/images/dashboard/' + customer.image + '.png'} alt={customer.image} className="product-image" />
                    </div>
                    <div>
                        <h4>{customer.user}</h4>
            ...
            <div className="grid">
                <div className="col-12 md:col-4">
                    <div className="card widget-overview-box widget-overview-box-1">
                        ...
                        <img src="public/assets/layout/images/dashboard/rate.svg" alt="rate" />
                    </div>
                </div>
                <div className="col-12 md:col-4">
                    <div className="card widget-overview-box widget-overview-box-2">
                        ...
                        <img src="public/assets/layout/images/dashboard/value.svg" alt="value" />
                    </div>
                </div>
                <div className="col-12 md:col-4">
                    <div className="card widget-overview-box widget-overview-box-3">
                        ...
                        <img src="public/assets/layout/images/dashboard/quantity.svg" alt="quantity" />
                    </div>
                </div>
                        ...
                        <div className="content">
                            <ul>
                                <li className="person-item">
                                    <Avatar image="public/assets/layout/images/dashboard/ann.png" className="mr-2 p-overlay-badge" shape="circle"><Badge value={1} /></Avatar>
                                ...
                                <li className="person-item">
                                    <Avatar image="public/assets/layout/images/dashboard/miracle.png" className="mr-2 p-overlay-badge" shape="circle"><Badge value={2} /></Avatar>
                                    <div className="person-info">
                                ...
                                <li className="person-item">
                                    <Avatar image="public/assets/layout/images/dashboard/kaylynn.png" className="mr-2 p-overlay-badge" shape="circle"><Badge value={3} /></Avatar>
                                    <div className="person-info">
                                ...
                                <li className="person-item">
                                    <Avatar image="public/assets/layout/images/dashboard/angel.png" className="mr-2 p-overlay-badge" shape="circle"><Badge value={4} /></Avatar>
                                    <div className="person-info">
                                ...
                                <li className="person-item">
                                    <Avatar image="public/assets/layout/images/dashboard/cristofer.png" className="mr-2 p-overlay-badge" shape="circle"><Badge value={5} /></Avatar>
                                    <div className="person-info">
