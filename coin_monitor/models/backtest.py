...
class LabAccount(models.Model):
    ...
    lab_account_sync = models.IntegerField(blank=True, null=True)
    lab_account_log = models.TextField(blank=True, null=True)
    lab_account_leap = models.IntegerField(blank=True, null=True)
...
class LabEventLogs(models.Model):
    ...
    lab_elog_result = models.JSONField(blank=True, null=True)
    ...
    lab_elog_base = models.JSONField(blank=True, null=True)
...
class LabNode(models.Model):
    ...
    lab_node_version = models.CharField(max_length=150, blank=True, null=True)
...
class LabOptResult(models.Model):
    ...
    lab_opt_result_done = models.IntegerField(blank=True, null=True)
    ...
    lab_opt_result_pending_event = models.IntegerField(blank=True, null=True)
...
class LabOptSchedule(models.Model):
    lab_opt_sche_id = models.AutoField(primary_key=True)
    lab_opt_sche_name = models.CharField(max_length=150, blank=True, null=True)
    lab_opt_sche_param = models.TextField(blank=True, null=True)
    lab_opt_sche_start = models.IntegerField(blank=True, null=True)
    lab_opt_sche_stop = models.IntegerField(blank=True, null=True)
    lab_opt_sche_status = models.IntegerField(blank=True, null=True)
    lab_opt_sche_note = models.TextField(blank=True, null=True)
    lab_opt_sche_log = models.TextField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'lab_opt_schedule'
...
class LabOptimization(models.Model):
    ...
    lab_opt_data_leng = models.IntegerField(blank=True, null=True)
    ...
    lab_opt_server = models.CharField(max_length=150, blank=True, null=True)
...
class LabResults(models.Model):
    ...
    lab_result_close_time = models.BigIntegerField(blank=True, null=True)
...
class LabStrategies(models.Model):
    ...
    lab_strategy_user = models.IntegerField(blank=True, null=True)
