...
def test_list_bots_unknown_asset_names_the_gap_in_vietnamese():
...
def test_get_assessment_unknown_code_is_vietnamese_not_a_traceback():
    ...
    assert "QC" in message or "chấm điểm" in message
...
def test_get_market_unknown_symbol_is_vietnamese_not_empty():
...
def test_http_transport_host_0_0_0_0_prints_vietnamese_warning():
