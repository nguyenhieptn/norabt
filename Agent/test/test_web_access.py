...
actual routes is covered in Agent/test/test_web_app.py.
"""
...
def _clean_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    OKX_*-sparing fixture in Agent/test/conftest.py) precisely BECAUSE this
    ...
    var set, exactly the machine-dependent flakiness Agent/test/conftest.py
...
# Agent/test/test_web_app.py; this section only exercises the sign/verify
# primitives directly.
# --------------------------------------------------------------------------- #
