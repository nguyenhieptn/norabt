...
Agent/none/test/test_dex_source.py; this file keeps the CEX-path tests plus the
...
def test_resolve_venue_dex_is_out_of_scope_for_live_source() -> None:
    ...
    # Agent/none/test/test_run_compare.py's `LiveMarketDataSource()` -- keep
    # working unmodified). See Agent/none/test/test_dex_source.py for the
...
# get_ticks_windowed, see Agent/none/test/test_tick_stream.py) is new,
