...
wall-clock time, per the same pattern Agent/none/test/test_live_poller.py already
...
def test_default_max_pages_matches_crawl_bots_cap_exactly():
    ...
    SAME depth Agent/none/scripts/crawl_bots.py's own default (--max-pages 5,
...
def test_garbage_code_nowhere_classifies_as_not_found_with_a_clear_message():
    ...
    NOT_FOUND, distinctly from LIMITED, with a clear explanation."""
    client = FakeOkxClient(
        weekly=[],
        leaderboard_rows=[],
        stats=None,
