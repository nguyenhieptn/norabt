"""CLI for the live incremental poller.
    ...
    python3 -m Agent.backend.scripts.run_live --once
    python3 -m Agent.backend.scripts.run_live --watch
    python3 -m Agent.backend.scripts.run_live --watch --interval 60
    python3 -m Agent.backend.scripts.run_live --bot <uniqueCode>
