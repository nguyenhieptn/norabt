"""CLI chẩn đoán: OKX connect được chưa, và tương tác được không.
    ...
    python3 -m Agent.backend.scripts.run_probe                       # public + private
    python3 -m Agent.backend.scripts.run_probe --copy-trading         # + dry-run copy trading
    python3 -m Agent.backend.scripts.run_probe --copy-trading --execute   # gọi thật (chỉ demo)
...
def main(argv: Any = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python3 -m Agent.backend.scripts.run_probe",
