...
Usage:
    python3 Agent/scripts/make_admin_token.py "my-secret-string"
    echo "my-secret-string" | python3 Agent/scripts/make_admin_token.py
    python3 Agent/scripts/make_admin_token.py   # prompts interactively
