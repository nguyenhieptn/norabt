...
- Golden/reference fixtures for PRD-05..07.

## 4. Processing rules

- Compare formulas, periods, thresholds and all decision branches.
...
- **AC-10.6.1:** ATR/Keltner/taxonomy mismatch resolved.
