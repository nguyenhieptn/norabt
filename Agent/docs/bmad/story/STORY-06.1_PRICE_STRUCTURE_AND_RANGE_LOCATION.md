# STORY-06.1: PRICE STRUCTURE AND RANGE LOCATION

> **Document ID:** STORY-06.1
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../prd/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Định vị giá trong cấu trúc quan sát.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Định vị giá trong cấu trúc quan sát.
...
- Closed highs/lows/closes, lookback.

## 4. Processing rules

- Compute range high/low/location with zero-range guard.
- Window and source timeframe versioned.

## 5. Output contract

- range_location_pct, structure_state, reasons.
...
- **AC-6.1.1:** Boundary/flat range fixtures.
