# STORY-09.5: ASSET MOVEMENT DENY BOUNDARY

> **Document ID:** STORY-09.5
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-09](../prd/PRD-09_OKX_INTERACTION_AND_AGENT_INTERFACE.md)
> **Source of truth for:** Cấm transfer/withdraw/deposit-management side effects.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Cấm transfer/withdraw/deposit-management side effects.
...
- Funding/sub-account path registry.

## 4. Processing rules

- Deny movement methods regardless model request.
- Credentials without such permission.

## 5. Output contract

- CapabilityDenied audit.
...
- **AC-9.5.1:** Negative tests cover transfer/withdraw.
