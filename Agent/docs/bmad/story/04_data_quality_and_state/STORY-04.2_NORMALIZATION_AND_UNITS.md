...
- ObservationEnvelope, instrument/token metadata.

## 4. Processing rules

- Strict parse; reject NaN/Inf; validate OHLC/orderbook ranges.
- Preserve raw unit and conversion formula/version.
- Normalization errors không bị swallow thành zero.

## 5. Output contract

- Normalized fact + `NormalizationReport`.
...
- **AC-4.2.1:** Golden unit fixtures.
- **AC-4.2.2:** Malformed field có reason code.
