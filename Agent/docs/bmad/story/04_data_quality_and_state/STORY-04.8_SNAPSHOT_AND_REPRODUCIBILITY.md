...
- Universe snapshot, normalized input refs, methodology.

## 4. Processing rules

- Generate immutable assessment_id.
- Store hashes/versions/as-of; human report references same ID.
- Recovery preserves stale age semantics.
...
- **AC-4.8.1:** Replay produces equivalent output except runtime metadata.
