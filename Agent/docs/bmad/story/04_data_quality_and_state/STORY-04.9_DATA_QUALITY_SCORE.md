# STORY-04.9: DATA QUALITY SCORE

> **Document ID:** STORY-04.9
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-04](../../spec/01_prd_engine1/PRD-04_DATA_QUALITY_PROVENANCE_AND_STATE.md)
> **Source of truth for:** Tính quality/completeness để quyết định eligibility.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Tính quality/completeness để quyết định eligibility.
...
- Availability, freshness, schema, gaps, source confidence.

## 4. Processing rules

- Component quality and required-source weights are versioned.
- Veto invalid schema/time.
- Do not let high market score override poor data quality.

## 5. Output contract

- quality_score, completeness, flags, eligibility recommendation.
...
- **AC-4.9.1:** Known fixtures yield deterministic score.
- **AC-4.9.2:** Threshold boundary tests.
