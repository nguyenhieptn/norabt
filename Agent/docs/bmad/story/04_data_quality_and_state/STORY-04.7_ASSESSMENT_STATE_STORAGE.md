...
- Versioned MarketRisk assessment.

## 4. Processing rules

- Single key namespace/version; atomic write; TTL/retention policy.
- Reader validates schema version.
- Không trộn nested JSON và flattened fields dưới cùng contract.

## 5. Output contract

- Persisted assessment + last-known state metadata.
...
- **AC-4.7.1:** Old/new readers contract-tested.
- **AC-4.7.2:** Duplicate StateBus path được retire trước gate pass.
