...
- event/observed/received times và source cadence.

## 4. Processing rules

- Compute freshness tại assessment cutoff.
- Threshold khác cho books, candles, funding, security.
- Clock skew và future timestamp bị flag.

## 5. Output contract

- `FRESH|AGING|STALE|INVALID_TIME`.
...
- **AC-4.3.1:** Stale book không ghi real-time.
- **AC-4.3.2:** Boundary tests cho mỗi threshold.
