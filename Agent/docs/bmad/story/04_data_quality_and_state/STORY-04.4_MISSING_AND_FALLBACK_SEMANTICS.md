...
- Expected source set và observed facts.

## 4. Processing rules

- Distinguish MISSING, UNKNOWN, NOT_APPLICABLE, INSUFFICIENT_DATA, SOURCE_ERROR, FALLBACK.
- Không coalesce numeric thiếu thành 0/1.0/default safe.
...
- **AC-4.4.1:** Missing taker/funding/security làm confidence giảm.
- **AC-4.4.2:** NOT_APPLICABLE không bị phạt như MISSING.
