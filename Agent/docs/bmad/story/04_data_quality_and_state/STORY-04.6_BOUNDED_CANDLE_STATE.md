...
- O(1) append target bằng circular pointer; ordered read semantics explicit.
- Không dùng np.roll/vstack claim zero allocation nếu còn copy.
- Reject unconfirmed candle at boundary.

## 5. Output contract

- `CandleWindow` interface.
...
- **AC-4.6.1:** Memory bounded over long run.
- **AC-4.6.2:** Chronological reads correct after wrap.
