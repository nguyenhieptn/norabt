...
- Disconnect, 429, Redis outage, stale cache, restart and malformed payload scenarios.
...
- **AC-10.12.1:** No silent data corruption; recovery bounded.
