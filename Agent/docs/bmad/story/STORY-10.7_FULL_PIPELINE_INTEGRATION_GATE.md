...
- Controlled fixture and integration environment.

## 4. Processing rules

- Trace one closed candle and full universe snapshot across every stage.
...
- **AC-10.7.1:** Live path calls full assessment, not simplified parallel path.
