...
- Versioned micro and macro regimes + quality.

## 4. Processing rules

- Decision matrix explicit for aligned/conflicting/compressed/choppy/unknown.
- Low-quality macro cannot silently override micro.

## 5. Output contract

- Confluence regime, trend state, bias, confidence, reasons.
...
- **AC-5.7.1:** All matrix cells covered.
- **AC-5.7.2:** Unknown propagation tested.
