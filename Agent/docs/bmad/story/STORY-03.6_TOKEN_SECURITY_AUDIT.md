# STORY-03.6: TOKEN SECURITY AUDIT

> **Document ID:** STORY-03.6
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../prd/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Đánh giá security evidence mà không tạo false safety.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Đánh giá security evidence mà không tạo false safety.
...
- Verified token-risk response.

## 4. Processing rules

- Normalize honeypot/mint/blacklist/tax/holder concentration.
- Phân biệt boolean false observed với field missing.
- API/auth failure => UNKNOWN/UNVERIFIED, không APPROVED.

## 5. Output contract

- `TokenSecurityEvidence` + field coverage.
...
- **AC-3.6.1:** Missing security không pass eligibility high-confidence.
- **AC-3.6.2:** Tax units decimal/% được test.
