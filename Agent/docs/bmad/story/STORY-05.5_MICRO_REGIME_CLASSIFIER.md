# STORY-05.5: MICRO REGIME CLASSIFIER

> **Document ID:** STORY-05.5
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-05](../prd/PRD-05_ENGINE1_REGIME_CORE.md)
> **Source of truth for:** Phân loại regime vi mô mutually exclusive.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Phân loại regime vi mô mutually exclusive.
...
- close, EMA, bands, width, EMA slope, sustained state.

## 4. Processing rules

- Decision precedence documented.
- Taxonomy version includes compressed/choppy/bull/bear/unknown.
- Avoid substring-only semantics in contract.

## 5. Output contract

- MicroRegime + reasons/confidence.
...
- **AC-5.5.1:** One golden fixture per branch.
- **AC-5.5.2:** No ambiguous overlapping result.
