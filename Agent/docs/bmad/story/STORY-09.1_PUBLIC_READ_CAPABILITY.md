...
- Allowlisted GET endpoints and WS channels.

## 4. Processing rules

- Classify and audit each call.
- No credentials required unless OKX endpoint says otherwise.

## 5. Output contract

- Public observations + audit metadata.
...
- **AC-9.1.1:** Inventory matches code.
