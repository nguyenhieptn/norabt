...
- Assessment repository and query filters.

## 4. Processing rules

- MCP returns structured contract or faithful projection.
- No direct recompute/fetch in formatter.
- Freshness and version included.

## 5. Output contract

- get_market_assessment/get_ranked_assessments report.
