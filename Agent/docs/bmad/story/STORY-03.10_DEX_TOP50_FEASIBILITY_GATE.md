# STORY-03.10: DEX TOP50 FEASIBILITY GATE

> **Document ID:** STORY-03.10
> **Type:** STORY
> **Status:** BLOCKED
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../prd/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Đưa ra quyết định có/không triển khai DEX Top 50.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Đưa ra quyết định có/không triển khai DEX Top 50.
...
- Evidence từ STORY-03.1..03.9.

## 4. Processing rules

- Gate discovery, pagination, chain coverage, pool metrics, security, routeability, freshness, rate budget và legal/permission class.
- Mỗi gate PASS/FAIL/BLOCKED có evidence.

## 5. Output contract

- `DEX_TOP50_APPROVED | NOT_APPROVED`.
...
- **AC-3.10.1:** Hiện trạng phải NOT_APPROVED/BLOCKED.
- **AC-3.10.2:** Chỉ sếp/owner đổi scope sau evidence review.
