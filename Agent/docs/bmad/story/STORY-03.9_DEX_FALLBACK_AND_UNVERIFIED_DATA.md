# STORY-03.9: DEX FALLBACK AND UNVERIFIED DATA

> **Document ID:** STORY-03.9
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../prd/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Quản lý fallback mà không gây hiểu sai.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Quản lý fallback mà không gây hiểu sai.
...
- Cached/local/synthetic values và source failure.

## 4. Processing rules

- Mọi fallback có `is_fallback`, `is_synthetic`, origin, generated_at.
- Không điền security=false/tax=0 hoặc volume ước lượng rồi gọi observed.
- Policy quyết định observe/exclude; luôn giảm confidence.

## 5. Output contract

- `FallbackEvidence` và reason codes.
...
- **AC-3.9.1:** Hard-coded pool fixture không lọt live Top 50.
- **AC-3.9.2:** Unavailable security hiển thị UNKNOWN.
