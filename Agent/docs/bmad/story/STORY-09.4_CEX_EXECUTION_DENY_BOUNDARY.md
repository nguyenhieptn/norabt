# STORY-09.4: CEX EXECUTION DENY BOUNDARY

> **Document ID:** STORY-09.4
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-09](../prd/PRD-09_OKX_INTERACTION_AND_AGENT_INTERFACE.md)
> **Source of truth for:** Cấm place/amend/cancel/set leverage.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Cấm place/amend/cancel/set leverage.
...
- Deny POST trade endpoints and WS order ops.
- No execution tool registration.
...
- **AC-9.4.1:** Static and runtime negative tests.
