...
- Fresh normalized orderbook; estimate path optional.

## 4. Processing rules

- Real L2 and volume estimate are distinct source types.
- Contract notional conversion required.
- Capacity bands methodology-versioned.

## 5. Output contract

- liquidity capacity/tier/source/confidence.
...
- **AC-6.9.1:** Estimate never labeled L2 observed.
