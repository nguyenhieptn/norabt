# STORY-06.11: MARKET INTELLIGENCE FUSION

> **Document ID:** STORY-06.11
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../../spec/01_prd_engine1/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Hợp nhất các facet thành một intelligence object.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Hợp nhất các facet thành một intelligence object.
...
- Outputs STORY-06.1..06.10 + regime + quality.

## 4. Processing rules

- No raw default injection.
- Supporting/contradicting reasons kept.
- Confidence accounts for applicability and quality.
...
- **AC-6.11.1:** Deterministic golden snapshots.
- **AC-6.11.2:** Full evaluator runtime wiring required for verified.
