# STORY-06.2: TREND STATE AND STRENGTH

> **Document ID:** STORY-06.2
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../../spec/01_prd_engine1/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Định lượng direction và strength tách khỏi regime label.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Định lượng direction và strength tách khỏi regime label.
...
- Regime, EMA slope, returns/structure evidence.

## 4. Processing rules

- Normalize strength 0..1; conflict lowers confidence.
- No default 0.5 presented as measured.

## 5. Output contract

- trend_state,strength,confidence,reasons.
...
- **AC-6.2.1:** Bull/bear/sideways/conflict fixtures.
