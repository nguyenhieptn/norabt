# STORY-06.10: DEX MARKET INTELLIGENCE APPLICABILITY

> **Document ID:** STORY-06.10
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../../spec/01_prd_engine1/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Chỉ áp dụng metric phù hợp cho DEX.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Chỉ áp dụng metric phù hợp cho DEX.
...
- Pool/token/quote evidence.

## 4. Processing rules

- No funding/OI/orderbook assumptions for AMM pool unless source exists.
- Use pool liquidity, route depth, impact, gas, security coverage.

## 5. Output contract

- DexMarketIntelligence + not_applicable fields.
...
- **AC-6.10.1:** CEX-only fields marked N/A, not zero.
