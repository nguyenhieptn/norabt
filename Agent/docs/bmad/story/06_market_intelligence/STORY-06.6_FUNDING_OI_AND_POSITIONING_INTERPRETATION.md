# STORY-06.6: FUNDING OI AND POSITIONING INTERPRETATION

> **Document ID:** STORY-06.6
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../../spec/01_prd_engine1/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Diễn giải derivatives evidence không gán nhãn quá mức.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Diễn giải derivatives evidence không gán nhãn quá mức.
...
- Funding/OI/delta/ratios with participant semantics.

## 4. Processing rules

- Thresholds methodology-versioned.
- Correlation does not imply smart-money intent.
- Missing series prevents z-score.

## 5. Output contract

- positioning_state,tension,reasons.
...
- **AC-6.6.1:** Extreme/neutral/missing fixtures.
