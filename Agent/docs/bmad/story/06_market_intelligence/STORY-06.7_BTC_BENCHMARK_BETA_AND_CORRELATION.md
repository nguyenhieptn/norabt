...
- Aligned asset/BTC return series.

## 4. Processing rules

- Common timestamps only; minimum samples; zero variance guard.
- BTC itself receives benchmark identity, not fake beta ranking.

## 5. Output contract

- beta,correlation,relative_strength,quality.
...
- **AC-6.7.1:** Misaligned series caught.
