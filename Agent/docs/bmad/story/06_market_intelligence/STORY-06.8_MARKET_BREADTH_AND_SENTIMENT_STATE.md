# STORY-06.8: MARKET BREADTH AND SENTIMENT STATE

> **Document ID:** STORY-06.8
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../../spec/01_prd_engine1/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Tổng hợp market-wide breadth/sentiment từ universe.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Tổng hợp market-wide breadth/sentiment từ universe.
...
Relevant current paths: `backend/core/engine_1/evaluator.py` and analyzer modules.
...
- Eligible per-item assessments and positioning evidence.

## 4. Processing rules

- Fixed denominator from universe snapshot.
- Separate price breadth and leverage sentiment.
- Coverage shown with every percentage.

## 5. Output contract

- MarketBreadth, MarketSentimentState.
...
- **AC-6.8.1:** 9/22 reports denominator; missing rows excluded/disclosed.
