# STORY-08.9: BREADTH CONCENTRATION AND OUTLIERS

> **Document ID:** STORY-08.9
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Cho thấy độ rộng, tập trung và bất thường.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Cho thấy độ rộng, tập trung và bất thường.
...
- Market breadth, liquidity/score arrays.

## 4. Processing rules

- Method and thresholds versioned.
- Outlier is statistical label, not trade instruction.

## 5. Output contract

- BreadthConcentrationOutliers.
...
- **AC-8.9.1:** Known distribution fixture.
