# STORY-08.12: HUMAN READABLE RENDERING

> **Document ID:** STORY-08.12
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Render list/table/report cho user/sếp.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Render list/table/report cho user/sếp.
...
- Validated machine report.

## 4. Processing rules

- Pure formatting; no recompute score/risk.
- Concise overview then drill-down.
- Example data labeled FIXTURE/HISTORICAL.
...
- **AC-8.12.1:** Renderer parity test with JSON.
