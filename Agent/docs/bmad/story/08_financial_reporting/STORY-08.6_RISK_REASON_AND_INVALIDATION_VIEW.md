# STORY-08.6: RISK REASON AND INVALIDATION VIEW

> **Document ID:** STORY-08.6
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Giải thích vì sao nơi đó bất lợi/đáng quan sát.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Giải thích vì sao nơi đó bất lợi/đáng quan sát.
...
Relevant current paths: `backend/data/schemas/models.py`, `backend/mcp/server.py`, `backend/core/engine_1/action_verdict_generator.py`.
...
- Risk/eligibility reasons and scenario assumptions.

## 4. Processing rules

- Distinguish observed warning, model inference and data limitation.
- Invalidation refers to assessment hypothesis, not automatic order management.
...
- **AC-8.6.1:** Every displayed reason code catalogued.
