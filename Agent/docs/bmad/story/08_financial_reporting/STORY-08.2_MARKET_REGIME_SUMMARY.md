# STORY-08.2: MARKET REGIME SUMMARY

> **Document ID:** STORY-08.2
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Tóm tắt market regime trong một khối dễ đọc.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Tóm tắt market regime trong một khối dễ đọc.
...
- MarketOverview and breadth.

## 4. Processing rules

- Render status, confidence, dominant/supporting/conflicting reasons and limitations.
- No action claim stronger than source state.
...
- **AC-8.2.1:** Golden bull/bear/sideways/unknown views.
