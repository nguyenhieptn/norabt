# STORY-08.8: DISTRIBUTION AND QUANTILE STATISTICS

> **Document ID:** STORY-08.8
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Mô tả score/risk distributions.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Mô tả score/risk distributions.
...
- Eligible cohort values.

## 4. Processing rules

- Define sample, missing policy, mean/median/std/quantiles/min/max.
- Do not compute misleading stats on tiny sample without warning.
...
- **AC-8.8.1:** Known vector calculations.
