# STORY-08.10: MISSINGNESS FRESHNESS AND SOURCE STATISTICS

> **Document ID:** STORY-08.10
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Hiển thị chất lượng dữ liệu toàn report.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Hiển thị chất lượng dữ liệu toàn report.
...
- Counts by source/status/fallback/stale/missing.
- Coverage percentage denominator shown.
