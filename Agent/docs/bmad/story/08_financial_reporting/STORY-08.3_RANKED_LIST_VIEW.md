...
- Show rank, identity, regime, risk, score, quality, eligibility and top reasons.
- Separate CEX/DEX.

## 5. Output contract

- Ranked list model/render.
...
- **AC-8.3.1:** Order equals machine rank.
