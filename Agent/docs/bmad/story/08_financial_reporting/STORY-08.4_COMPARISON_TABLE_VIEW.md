...
- Per-item assessments and ranks.

## 4. Processing rules

- Columns typed/versioned; units in header.
- Unknown/stale visually explicit.
- Sortable projection cannot mutate assessment.
...
- **AC-8.4.1:** Cell values trace to row contract.
