# STORY-08.7: UNIVERSE COVERAGE STATISTICS

> **Document ID:** STORY-08.7
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-08](../../spec/01_prd_engine1/PRD-08_ENGINE1_REPORTING.md)
> **Source of truth for:** Thống kê discovered/eligible/assessed/excluded.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Thống kê discovered/eligible/assessed/excluded.
...
- Universe and result manifests.

## 4. Processing rules

- Report CEX/DEX separately; denominators explicit.
- Failures/stale/unknown counted.
...
- **AC-8.7.1:** Counts reconcile exactly.
