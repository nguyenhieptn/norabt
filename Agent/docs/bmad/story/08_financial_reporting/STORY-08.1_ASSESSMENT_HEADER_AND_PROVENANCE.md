...
- Include ID, as-of, universe/methodology/schema versions, cohort coverage and source summary.
...
- **AC-8.1.1:** All views reference identical header ID.
