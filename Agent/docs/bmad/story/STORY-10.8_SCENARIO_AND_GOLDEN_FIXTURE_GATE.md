...
- Bull/bear/sideways/choppy, squeeze, thin liquidity, honeypot, stale/missing fixtures.

## 4. Processing rules

- Assert regime, risk, eligibility, rank reasons and confidence.
...
- **AC-10.8.1:** All mandatory cases pass.
