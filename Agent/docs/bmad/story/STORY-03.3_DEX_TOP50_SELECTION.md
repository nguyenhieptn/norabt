# STORY-03.3: DEX TOP50 SELECTION

> **Document ID:** STORY-03.3
> **Type:** STORY
> **Status:** BLOCKED
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../prd/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Chọn Top 50 DEX sau khi discovery được chứng minh.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Chọn Top 50 DEX sau khi discovery được chứng minh.
...
- Verified discovery, pool metrics, security, quoteability, quality.

## 4. Processing rules

- Eligibility: identity/security/freshness/routeability trước score.
- Score liquidity+volume+depth+quality; cohort DEX riêng.
- Không rank synthetic/unverified cùng observed.

## 5. Output contract

- `DexUniverseV1` tối đa 50 rows.
...
- **AC-3.3.1:** STORY-03.2 phải pass.
- **AC-3.3.2:** Mỗi row có pool/chain/source.
