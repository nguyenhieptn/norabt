# STORY-09.6: DEX QUOTE VS EXECUTION BOUNDARY

> **Document ID:** STORY-09.6
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-09](../prd/PRD-09_OKX_INTERACTION_AND_AGENT_INTERFACE.md)
> **Source of truth for:** Phân biệt quote với transaction execution.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Phân biệt quote với transaction execution.
...
- DEX quote/route request.

## 4. Processing rules

- Allow observation.
- Transaction build, approval, wallet signature and broadcast prohibited.
- Output includes execution_authorized=false.
...
- **AC-9.6.1:** No signing/broadcast dependencies reachable.
