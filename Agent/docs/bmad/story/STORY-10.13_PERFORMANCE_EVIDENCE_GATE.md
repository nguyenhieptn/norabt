...
- Representative Top50 workload.

## 4. Processing rules

- Record hardware/software, warm-up, samples, p50/p95/p99 for engine/persistence/end-to-end/MCP and resource peaks.
...
- **AC-10.13.1:** Thresholds approved and met; no single-run claim.
