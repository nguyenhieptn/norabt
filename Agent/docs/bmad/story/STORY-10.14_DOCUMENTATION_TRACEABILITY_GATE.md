...
- All active PRD/STORY docs.

## 4. Processing rules

- Validate links, metadata, parent IDs, source paths and evidence references; scan overclaims.
...
- **AC-10.14.1:** No orphan story or legacy inbound link.
