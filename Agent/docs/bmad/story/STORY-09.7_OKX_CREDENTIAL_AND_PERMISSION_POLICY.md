# STORY-09.7: OKX CREDENTIAL AND PERMISSION POLICY

> **Document ID:** STORY-09.7
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-09](../prd/PRD-09_OKX_INTERACTION_AND_AGENT_INTERFACE.md)
> **Source of truth for:** Quản trị key/passphrase theo capability.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Quản trị key/passphrase theo capability.
...
- Environment credentials and deployment config.

## 4. Processing rules

- Least privilege, IP binding target, rotation/redaction.
- Signer only signs allowlisted request.
- Unauthenticated fallback explicit.

## 5. Output contract

- CredentialHealth without secrets.
...
- **AC-9.7.1:** Logs contain no secrets.
- **AC-9.7.2:** Trade permission absent.
