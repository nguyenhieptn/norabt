# STORY-07.8: ELIGIBILITY GATE

> **Document ID:** STORY-07.8
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-07](../../spec/01_prd_engine1/PRD-07_ENGINE1_RISK_SCORING_AND_RANKING.md)
> **Source of truth for:** Quyết định eligible/observe/exclude trước score.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Quyết định eligible/observe/exclude trước score.
...
- Identity, required evidence, risk tier, quality.

## 4. Processing rules

- Hard exclusions first; observation-only for partial data.
- No score for invalid identity/veto/source unavailable.

## 5. Output contract

- EligibilityDecision with reasons.
...
- **AC-7.8.1:** Every exclusion deterministic.
