...
- Approved DEX universe and eligible score rows.

## 4. Processing rules

- Never mix chain/pool identity.
- Separate score calibration from CEX.
- Blocked until STORY-03.10 passes.

## 5. Output contract

- DEX ranked list or blocked result.
...
- **AC-7.12.1:** Cannot pass while discovery gate blocked.
