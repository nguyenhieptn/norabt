...
- STORY-06.9 output + order size assumption.

## 4. Processing rules

- Risk conditional on assumed notional.
- Stale/estimated data increases uncertainty.
- No universal “safe” tier.
...
- **AC-7.3.1:** Thin/deep/stale/estimate scenarios.
