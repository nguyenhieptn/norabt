...
- CEX/DEX applicable risk facets.

## 4. Processing rules

- Order: VETO > CRITICAL > HIGH > MEDIUM > LOW; UNKNOWN remains explicit when coverage insufficient.
- Reason codes retain all dominant causes.

## 5. Output contract

- overall tier, tradeable assessment flag, confidence, reasons.
...
- **AC-7.7.1:** Precedence matrix fully tested.
