...
- Observed honeypot can veto.
- Tax/privilege/concentration thresholds versioned.
- Missing audit => UNKNOWN, not LOW.
...
- **AC-7.4.1:** Honeypot/tax/unknown fixtures.
