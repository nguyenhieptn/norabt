...
- Normalized components, quality, weight set.

## 4. Processing rules

- Weights sum/validation explicit.
- Quality penalty separate and visible.
- No hidden hard-coded overrides.

## 5. Output contract

- score, breakdown, methodology_version.
...
- **AC-7.10.1:** Hand-calculated fixture exact within tolerance.
