...
- DataQuality from PRD-04.

## 4. Processing rules

- Map quality to uncertainty tier.
- Critical source missing can exclude.
- Uncertainty cannot be canceled by bullish market score.
...
- **AC-7.6.1:** Poor quality blocks eligibility.
