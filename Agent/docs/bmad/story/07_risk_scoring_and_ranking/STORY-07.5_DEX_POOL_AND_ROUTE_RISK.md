...
- Pool liquidity/concentration, quote route/expiry.

## 4. Processing rules

- Separate pool, route and chain facets.
- Expired/no-route => ineligible.
- Impact conditional on amount.
...
- **AC-7.5.1:** Deep/thin/expired/no-route fixtures.
