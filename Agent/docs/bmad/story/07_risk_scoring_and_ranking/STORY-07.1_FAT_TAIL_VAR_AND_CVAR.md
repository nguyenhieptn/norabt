# STORY-07.1: FAT TAIL VAR AND CVAR

> **Document ID:** STORY-07.1
> **Type:** STORY
> **Status:** CURRENT-UNVERIFIED
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-07](../../spec/01_prd_engine1/PRD-07_ENGINE1_RISK_SCORING_AND_RANKING.md)
> **Source of truth for:** Định nghĩa VaR/CVaR và giới hạn thống kê.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Định nghĩa VaR/CVaR và giới hạn thống kê.
...
- Sufficient clean return series, alpha/horizon.

## 4. Processing rules

- Cornish-Fisher formula/version documented.
- Small sample/zero variance => insufficient or qualified estimate, not favorable constants.
- CVaR estimator limitations disclosed.

## 5. Output contract

- var,cvar,skew,kurtosis,sample_count,quality.
...
- **AC-7.1.1:** Reference distribution fixtures.
- **AC-7.1.2:** Small-sample semantics tested.
