# STORY-07.13: RANK STABILITY AND TIEBREAK

> **Document ID:** STORY-07.13
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-07](../../spec/01_prd_engine1/PRD-07_ENGINE1_RISK_SCORING_AND_RANKING.md)
> **Source of truth for:** Ngăn rank nhảy vô nghĩa và bảo đảm reproducibility.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Ngăn rank nhảy vô nghĩa và bảo đảm reproducibility.
...
- Current/previous ranks and same-methodology scores.

## 4. Processing rules

- Deterministic tie-break.
- Optional presentation smoothing cannot alter raw rank.
- Methodology change resets comparability.

## 5. Output contract

- raw rank, delta, stability annotation.
...
- **AC-7.13.1:** Tie and near-tie fixtures.
