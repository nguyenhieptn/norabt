...
- Eligible CEX score rows from same snapshot.

## 4. Processing rules

- Sort score desc then quality/freshness then instId.
- Benchmark row clearly marked.
- Excluded rows shown separately.

## 5. Output contract

- CEX ranked list + exclusions.
...
- **AC-7.11.1:** Stable repeated rank.
