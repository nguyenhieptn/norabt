# STORY-05.8: BREAKOUT AND FAKEOUT

> **Document ID:** STORY-05.8
> **Type:** STORY
> **Status:** CURRENT-UNVERIFIED
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-05](../prd/PRD-05_ENGINE1_REGIME_CORE.md)
> **Source of truth for:** Đánh giá breakout sau compression bằng close/flow.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Đánh giá breakout sau compression bằng close/flow.
...
- Closed candle, bands, prior compression state, taker/flow evidence.

## 4. Processing rules

- No wick-only trigger.
- Prior compression required by chosen methodology.
- Flow missing yields unconfirmed/low-confidence, not neutral confirmation.

## 5. Output contract

- BreakoutState NONE/CANDIDATE/CONFIRMED/REJECTED.
...
- **AC-5.8.1:** Closed above/below, weak flow, missing flow fixtures.
