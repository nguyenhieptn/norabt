# STORY-05.3: KELTNER WIDTH AND VOLATILITY STATE

> **Document ID:** STORY-05.3
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-05](../prd/PRD-05_ENGINE1_REGIME_CORE.md)
> **Source of truth for:** Tính bands/width/z-score và volatility state.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Tính bands/width/z-score và volatility state.
...
- EMA, ATR, multiplier, width history.

## 4. Processing rules

- Upper/lower=EMA±k*ATR; relative width denominator validated.
- Rolling history bounded; z-score handles zero variance.
- Resolve 1.5 vs 2.0/dual bands.

## 5. Output contract

- bands, width, zscore, percentile, volatility state.
...
- **AC-5.3.1:** Constant-width fixture stable.
- **AC-5.3.2:** Methodology version identifies multiplier.
