# STORY-03.1: CHAIN AND TOKEN IDENTITY

> **Document ID:** STORY-03.1
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../../spec/01_prd_engine1/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Tạo identity duy nhất cho token/pool đa chain.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Tạo identity duy nhất cho token/pool đa chain.
...
- chainId, token address, pool address, token metadata.

## 4. Processing rules

- Identity = chainId + normalized address; symbol chỉ display.
- Lấy decimals từ metadata, không hard-code 18/6.
- Pool identity tách token identity.

## 5. Output contract

- `ChainTokenId`, `DexPoolId`, `TokenMetadata`.
...
- **AC-3.1.1:** Symbol collision khác chain không merge.
- **AC-3.1.2:** Native/wrapped token được phân biệt.
