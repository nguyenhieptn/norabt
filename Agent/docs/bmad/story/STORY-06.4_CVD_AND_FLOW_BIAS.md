# STORY-06.4: CVD AND FLOW BIAS

> **Document ID:** STORY-06.4
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../prd/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Đánh giá cumulative flow và direction.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Đánh giá cumulative flow và direction.
...
- Measured aggressor-side trades/taker volume or estimated candle proxy.

## 4. Processing rules

- Measured and estimated paths never share unlabeled field.
- Window alignment and divergence rules versioned.

## 5. Output contract

- cvd,flow_bias,divergence,source_quality.
...
- **AC-6.4.1:** Measured/estimated fixture labels preserved.
