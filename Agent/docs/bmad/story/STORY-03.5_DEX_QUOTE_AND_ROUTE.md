# STORY-03.5: DEX QUOTE AND ROUTE

> **Document ID:** STORY-03.5
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../prd/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Lấy quote/route quan sát, không thực thi swap.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Lấy quote/route quan sát, không thực thi swap.
...
- chain-qualified tokens, metadata decimals, raw amount, quote source.

## 4. Processing rules

- Encode amount bằng source decimals.
- Parse route, output amount, price impact, gas và expiry đúng schema.
- Quote failure trả error/unknown; không fallback CEX như DEX quote.

## 5. Output contract

- `DexQuoteObservation` với expires_at và `execution_authorized=false`.
...
- **AC-3.5.1:** Fixture token decimals khác 18/6.
- **AC-3.5.2:** Expired quote không dùng cho assessment live.
