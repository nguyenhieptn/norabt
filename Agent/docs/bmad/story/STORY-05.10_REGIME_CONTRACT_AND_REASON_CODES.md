# STORY-05.10: REGIME CONTRACT AND REASON CODES

> **Document ID:** STORY-05.10
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-05](../prd/PRD-05_ENGINE1_REGIME_CORE.md)
> **Source of truth for:** Khóa contract regime dùng toàn hệ thống.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Khóa contract regime dùng toàn hệ thống.
...
- Outputs STORY-05.1..05.9.

## 4. Processing rules

- Versioned enums, reason code catalog, confidence formula, unavailable states.
- Human labels separate schema values.
...
- **AC-5.10.1:** Schema/golden snapshot tests.
- **AC-5.10.2:** Docs/code taxonomy exact match.
