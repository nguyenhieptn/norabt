...
- PRD-02/03 source stories.

## 4. Processing rules

- Every required metric has verified official source or explicit unsupported decision.
...
- **AC-10.2.1:** No unsupported source called OKX.
