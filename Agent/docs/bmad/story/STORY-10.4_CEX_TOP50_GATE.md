...
- Top50 universe, source budget, full assessment report.

## 4. Processing rules

- Run sustained Top50 refresh/stream/evaluate/report; measure coverage/errors/resources.
...
- **AC-10.4.1:** 50 or declared available count assessed from same snapshot within limits.
