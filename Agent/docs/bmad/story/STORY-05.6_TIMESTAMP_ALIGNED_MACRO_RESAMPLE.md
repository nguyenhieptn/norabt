# STORY-05.6: TIMESTAMP ALIGNED MACRO RESAMPLE

> **Document ID:** STORY-05.6
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-05](../prd/PRD-05_ENGINE1_REGIME_CORE.md)
> **Source of truth for:** Tạo nến macro đúng boundary.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Tạo nến macro đúng boundary.
...
- Closed micro candles with timestamps/timezone.

## 4. Processing rules

- Bucket by UTC timeframe boundary.
- Require complete expected candle count and continuity.
- Reject incomplete final bucket; OHLCV aggregation exact.

## 5. Output contract

- Closed macro candles + coverage.
...
- **AC-5.6.1:** 08:07 start không tạo fake 08:07-08:21 bar.
- **AC-5.6.2:** Missing minute invalidates/flags bucket.
