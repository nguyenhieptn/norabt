# STORY-09.10: CAPABILITY NEGATIVE TESTS

> **Document ID:** STORY-09.10
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-09](../prd/PRD-09_OKX_INTERACTION_AND_AGENT_INTERFACE.md)
> **Source of truth for:** Chứng minh không execution/asset movement.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Chứng minh không execution/asset movement.
...
- Endpoint/method imports, routes, tool registry, dependency graph.

## 4. Processing rules

- Static scan plus runtime denied-call tests.
- Evidence stored with date/commit.
- “No caller found” distinguished from formal enforcement.
...
- **AC-9.10.1:** All prohibited classes pass denial test.
