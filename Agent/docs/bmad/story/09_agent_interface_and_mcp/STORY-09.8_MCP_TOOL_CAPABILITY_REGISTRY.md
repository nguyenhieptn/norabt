...
- Record cache-read/live-read/auth-read/local-write.
- Tool cannot call unregistered capability.
...
- **AC-9.8.1:** Seven current tools audited; docs match actual return type.
