# STORY-06.5: ORDERBOOK IMBALANCE AND ABSORPTION

> **Document ID:** STORY-06.5
> **Type:** STORY
> **Status:** PARTIAL
> **Scope:** CURRENT + TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../prd/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Đo OBI và absorption từ fresh valid book.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Đo OBI và absorption từ fresh valid book.
...
- Validated L2 book and optional trades.

## 4. Processing rules

- Define depth band/weighting.
- Require sequence-valid, fresh snapshot.
- Absorption requires price+flow evidence; otherwise UNKNOWN.

## 5. Output contract

- obi,absorption_state,confidence.
...
- **AC-6.5.1:** Stale/gapped book rejected.
