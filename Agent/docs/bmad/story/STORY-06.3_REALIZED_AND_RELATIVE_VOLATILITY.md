# STORY-06.3: REALIZED AND RELATIVE VOLATILITY

> **Document ID:** STORY-06.3
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-06](../prd/PRD-06_ENGINE1_MARKET_INTELLIGENCE.md)
> **Source of truth for:** Đo realized và relative volatility.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Đo realized và relative volatility.
...
- Timestamp-aligned returns and benchmark.

## 4. Processing rules

- Define horizon/annualization; robust zero/missing handling.
- Relative measure only if synchronized samples sufficient.

## 5. Output contract

- realized_vol,relative_vol,volatility_band.
...
- **AC-6.3.1:** Known return vector.
- **AC-6.3.2:** Insufficient overlap explicit.
