# STORY-03.7: CHAIN AND SMART CONTRACT RISK

> **Document ID:** STORY-03.7
> **Type:** STORY
> **Status:** TARGET
> **Scope:** TARGET
> **Evidence as of:** 2026-09-12
> **Parent PRD:** [PRD-03](../prd/PRD-03_OKX_DEX_ONCHAIN_DATA_FOUNDATION.md)
> **Source of truth for:** Xác định applicability và risk theo chain/contract.
> **Supersedes:** Related fragment in legacy BMAD documents

## 1. Purpose and boundary

Xác định applicability và risk theo chain/contract.
...
- Chain status, token/pool security, coverage metadata.

## 4. Processing rules

- Không suy diễn chain risk từ token risk.
- Risk tier mang source coverage/confidence.
- Unsupported chain => UNKNOWN/EXCLUDE theo policy.

## 5. Output contract

- `OnchainRiskAssessment`.
...
- **AC-3.7.1:** Mỗi veto có observed evidence.
- **AC-3.7.2:** Unknown không bị ghi LOW.
