...
- **Tệp kiểm thử:**
  - `Agent/none/test/test_market_sources.py`: Kiểm thử dữ liệu nến đóng và tính toán ATR.
  - `Agent/none/test/test_qc_signals.py`: Kiểm thử tín hiệu chuyển pha thị trường.
