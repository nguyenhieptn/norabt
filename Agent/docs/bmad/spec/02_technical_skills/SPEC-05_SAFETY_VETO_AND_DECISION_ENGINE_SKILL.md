...
- **Tệp kiểm thử:**
  - `Agent/none/test/test_quality_verdict.py`: Kiểm thử phân loại 4 góc phần tư.
  - `Agent/none/test/test_verdict_horizon.py`: Kiểm tra tính bền vững của xếp loại qua các khung thời gian.
