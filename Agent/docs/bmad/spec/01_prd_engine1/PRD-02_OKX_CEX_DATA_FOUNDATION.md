...
- [02.1 INSTRUMENT_AND_CONTRACT_METADATA](../../story/02_cex_data_foundation/STORY-02.1_INSTRUMENT_AND_CONTRACT_METADATA.md) — `PARTIAL`
- [02.2 CEX_UNIVERSE_DISCOVERY](../../story/02_cex_data_foundation/STORY-02.2_CEX_UNIVERSE_DISCOVERY.md) — `PARTIAL`
- [02.3 CEX_TOP50_SELECTION](../../story/02_cex_data_foundation/STORY-02.3_CEX_TOP50_SELECTION.md) — `PARTIAL`
- [02.4 CLOSED_CANDLE_BACKFILL](../../story/02_cex_data_foundation/STORY-02.4_CLOSED_CANDLE_BACKFILL.md) — `PARTIAL`
- [02.5 CLOSED_CANDLE_STREAM](../../story/02_cex_data_foundation/STORY-02.5_CLOSED_CANDLE_STREAM.md) — `PARTIAL`
- [02.6 ORDERBOOK_L2](../../story/02_cex_data_foundation/STORY-02.6_ORDERBOOK_L2.md) — `PARTIAL`
- [02.7 TRADES_AND_TAKER_FLOW](../../story/02_cex_data_foundation/STORY-02.7_TRADES_AND_TAKER_FLOW.md) — `PARTIAL`
- [02.8 FUNDING_OPEN_INTEREST_AND_POSITIONING](../../story/02_cex_data_foundation/STORY-02.8_FUNDING_OPEN_INTEREST_AND_POSITIONING.md) — `PARTIAL`
- [02.9 LIQUIDATION_EVIDENCE](../../story/02_cex_data_foundation/STORY-02.9_LIQUIDATION_EVIDENCE.md) — `BLOCKED`
- [02.10 CEX_RATE_LIMIT_AND_RECOVERY](../../story/02_cex_data_foundation/STORY-02.10_CEX_RATE_LIMIT_AND_RECOVERY.md) — `TARGET`
