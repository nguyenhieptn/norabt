...
- [04.1 RAW_OBSERVATION_ENVELOPE](../../story/04_data_quality_and_state/STORY-04.1_RAW_OBSERVATION_ENVELOPE.md) — `TARGET`
- [04.2 NORMALIZATION_AND_UNITS](../../story/04_data_quality_and_state/STORY-04.2_NORMALIZATION_AND_UNITS.md) — `PARTIAL`
- [04.3 FRESHNESS_AND_STALENESS](../../story/04_data_quality_and_state/STORY-04.3_FRESHNESS_AND_STALENESS.md) — `TARGET`
- [04.4 MISSING_AND_FALLBACK_SEMANTICS](../../story/04_data_quality_and_state/STORY-04.4_MISSING_AND_FALLBACK_SEMANTICS.md) — `TARGET`
- [04.5 DEDUP_GAP_AND_ORDERING](../../story/04_data_quality_and_state/STORY-04.5_DEDUP_GAP_AND_ORDERING.md) — `TARGET`
- [04.6 BOUNDED_CANDLE_STATE](../../story/04_data_quality_and_state/STORY-04.6_BOUNDED_CANDLE_STATE.md) — `PARTIAL`
- [04.7 ASSESSMENT_STATE_STORAGE](../../story/04_data_quality_and_state/STORY-04.7_ASSESSMENT_STATE_STORAGE.md) — `PARTIAL`
- [04.8 SNAPSHOT_AND_REPRODUCIBILITY](../../story/04_data_quality_and_state/STORY-04.8_SNAPSHOT_AND_REPRODUCIBILITY.md) — `TARGET`
- [04.9 DATA_QUALITY_SCORE](../../story/04_data_quality_and_state/STORY-04.9_DATA_QUALITY_SCORE.md) — `TARGET`
