...
- **Tệp kiểm thử:**
  - `Agent/test/test_qc_signals.py`: Kiểm tra độ nhạy và tính toán của từng lăng kính.
  - `Agent/test/test_quality_and_safety.py`: Kiểm thử tổng hợp 10 lăng kính rủi ro.
