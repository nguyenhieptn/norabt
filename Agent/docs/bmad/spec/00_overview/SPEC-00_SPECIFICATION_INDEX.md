...
| [SPEC-07](file:///home/ubuntu/norabt/Agent/docs/bmad/spec/02_technical_skills/SPEC-07_MCP_SERVER_AND_MICRO_PAYMENTS_SKILL.md) | **Máy Chủ MCP & Thanh Toán Vi Mô x402** | `Agent/backend/agent_server.py`, `payments/x402.py` | Chuẩn JSON-RPC 2.0, 6 tools MCP, USDC micro-payments trên X Layer |
