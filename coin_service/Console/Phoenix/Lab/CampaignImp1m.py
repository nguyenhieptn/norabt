...
class CampaignImp1m(CampaignImp):
    ...
    def wattingOrder(self, orderType, container, strategy, flow, flowName, reason = ''):
        ...
        #skip waitting and to to step make order. match price is calculate in make order function.
    ...
    def monitorMatched(self, flowName):
        ...
        isMatchPrice = self.getFlowData(flowName, 'using_match_price')
