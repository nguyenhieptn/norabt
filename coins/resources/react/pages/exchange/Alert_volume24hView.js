...
import FuncEditAlertVolume24h from '../../components/admin/FuncEditAlertVolume24h';
import FuncAddAlertVolume24h from '../../components/admin/FuncAddAlertVolume24h';


class Alert_volume24hView extends Component {
    constructor(props) {
		super(props);
		this.id = makeId();
...
{/* 
              <FuncEditAlertOrderTrack reload={() => this.reloadOrigin()} ref={c => this.EditModel = c}></FuncEditAlertOrderTrack>
			  <FuncAddAlertOrderTrack  reload={() => this.reloadOrigin()} ref={c => this.AddModel = c}></FuncAddAlertOrderTrack> */}

			  <FuncEditAlertVolume24h reload={() => this.reloadOrigin()} ref={c => this.EditModel = c}></FuncEditAlertVolume24h>
			  <FuncAddAlertVolume24h reload={() => this.reloadOrigin()} ref={c => this.AddModel = c}></FuncAddAlertVolume24h>
...
export default Alert_volume24hView;