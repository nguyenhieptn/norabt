...
import FuncAddAlertCoinMarket from '../../components/admin/FuncAddAlertCoinMarket';
import FuncEditAlertCoinMarket from '../../components/admin/FuncEditAlertCoinMarket';



class Alert_coinmarketView extends Component {
    constructor(props) {
		super(props);
		this.id = makeId();
	...
	saveData() {
        ...
        var ctrl = new Ctrl();
        ctrl.set({ 'coin_market_alter': JSON.stringify(this.state.config) }).then(res => {
            this.loadOrigin();
	...
	async loadOrigin() {
        var ctrl = new Ctrl();
        ctrl.get('coin_market_alter', null).then(cfg => {
	...
	render() {
		...
		return (
			<>
			  ...
			  <FuncAddAlertCoinMarket reload={() => this.reloadOrigin()} ref={c => this.AddModel = c}></FuncAddAlertCoinMarket>
			  <FuncEditAlertCoinMarket reload={() => this.reloadOrigin()} ref={c => this.EditModel = c}></FuncEditAlertCoinMarket>
...
export default Alert_coinmarketView;