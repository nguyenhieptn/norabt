...
import ChartBalance from '../../components/Dashboard/Real/ChartBalance';
				...
				<div className='p-grid dashboard' >
					...
					<div className='p-col-12 p-lg-3 d-flex' >
						<div className='box-cus box-1' style={{ width: '100%' }}>
							<div className='box-cus-title'>
								...
								<span className='box-cus-title'>Total Investment </span>

							</div>
							<div className="overview-box-count ">{`${this.state.totalInvest}  `}</div>
						</div>
					...
					<div className='p-col-12 p-lg-3 d-flex' >
						<div className='box-cus box-2' style={{ width: '100%' }}>
							...
							<div className="overview-box-count">{`${this.state.totalProfit} / ${this.state.totalInvest != 0 && ((this.state.totalProfit / this.state.totalInvest) * 100).toFixed(2)} `}</div>
						</div>
