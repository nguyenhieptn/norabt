...
import UsedWeightChart from '../../components/admin/UsedWeightChart'
...
class Order_trackView extends Component {
	...
	render() {
		return (
			<div>
				...
				<Chart_WMA_Gauge_Copy ref={c => this.Chart_WMA_Gauge_Copy = c} ></Chart_WMA_Gauge_Copy>
				...
				<UsedWeightChart></UsedWeightChart>
...
export default Order_trackView