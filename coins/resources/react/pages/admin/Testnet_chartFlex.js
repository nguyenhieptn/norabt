...
class ChartFlex extends Component {
    ...
    componentDidMount(){
        ...
        model.getAccounts(this.mode).then(res => {
            if(res){
    ...
    render(){
        return <div>
            ...
            <ChartFlexItem ref={c => this.chartPrice = c} id="flex_00" sync={this.chartSycn} parent = {this} isPosition={true}></ChartFlexItem>
            <ChartFlexItem ref={c => this.chartFlex1 = c} id="flex_01" sync={this.chartSycn} parent = {this}></ChartFlexItem>
            <ChartFlexItem ref={c => this.chartFlex2 = c} id="flex_02" sync={this.chartSycn} parent = {this}></ChartFlexItem>
        </div>
    }
}
