...
import FuncEditAlertOrderTrack from '../../components/admin/FuncEditAlertOrderTrack';
import FuncAddAlertOrderTrack from '../../components/admin/FuncAddAlertOrderTrack';

class Alert_order_trackView extends Component {
	constructor(props) {
		super(props);
		this.id = makeId();
	...
	async loadOrigin() {
		var ctrl = new Ctrl();
		ctrl.get('alarm_configuration', null).then(cfg => {
...
export default Alert_order_trackView;