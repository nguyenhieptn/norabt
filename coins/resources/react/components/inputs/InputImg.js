			...
			<div {...this.rent}>
				...
				<div>
					{ (this.state.value == '' || !this.fileManager)
						? <div className='box_flex' style={{ justifyContent:'center', color:'darkgray', minHeight:100}}><i className="fa fa-picture-o" aria-hidden="true" style={{fontSize:48}}></i></div>
						: <div className='box_flex' style={{ justifyContent:'center', padding:5 }}><img style={{width:'90%'}} src={`${this.fileManager.props.links.read.link}?file=${this.state.value}`}></img></div>
					}
				</div>
