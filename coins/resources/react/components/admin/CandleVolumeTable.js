...
class CandleVolumeTable extends Component {
            ...
            //  var a = ['M5', 'M4', 'M3', 'M2', 'M1', 'M0'];
             ...
             dataOk.map(item => {
              ...
              Object.values(tableData).map(row => {
                row['M0'] = row['M0'] / row['M1'];
                row['M1'] = row['M1'] / row['M2'];
                row['M2'] = row['M2'] / row['M3'];
                row['M3'] = row['M3'] / row['M4'];
                row['M4'] = row['M4'] / row['M5'];
    ...
    getData1w(){
       ...
       return axios.request({
            ...
            Object.values(tableData).map(row => {
                row['w0'] = row['w0'] / row['w1'];
                row['w1'] = row['w1'] / row['w2'];
                row['w2'] = row['w2'] / row['w3'];
                row['w3'] = row['w3'] / row['w4'];
                row['w4'] = row['w4'] / row['w5'];
...
export default CandleVolumeTable