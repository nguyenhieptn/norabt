...
class ChartFlowRisky2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected: true,
            ...
            ChartOptions: {
                ...
                title: {
                    text: '<b> Flow Risky2</b>',
                    // align: 'left',
                    // x: 60,
                    // y: 18
                },
                xAxis: {
                    categories: ['4h-Risky2', '1d-Risky2'],
                },
                yAxis: {
        ...
        resultModel.getByAccountTestnet(App.accountSelectorTestnet.selected()).then(res => {
            if (res['data']) {
                ...
                res.map(item => {
                    ...
                    if (index > -1) {
                        if (flow == '1D-Risky2-LONG') {

                            data1D[index] += 1;
                        } else if (flow == '4H-Risky2-LONG') {
                            data4H[index] += 1;
                        }
...
export default ChartFlowRisky2;