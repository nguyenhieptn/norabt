...
class ChartParse extends Component {
            ...
            <>
                ...
                <div className='p-col-12 p-md-12 ' >
                    ...
                    <div className='box_shadow ' ref={c => this.chartContainer = c} style={{ position: 'relative' }}>
                        <div className='cus-hide' style={{ display: 'flex', alignItems: 'center', padding: 7, position: 'absolute', zIndex: 1, top: '35px', left: '41px' }}>
                            {
                                this.Frame.map(item => (
                                    <div
                                        key={item.text}
    ...
    getData() {
        ...
        // resultModel.get([[[TESTNET_RESULT_STRATEGY, '=', App.strategySelector.selected()]]]).then(res => {
            ...
            if (res['data']) {
                ...
                for (let i in res) {
                    ...
                    var phase = res[i][TESTNET_RESULT_PHASE];
