...
class FilterBar extends Component {
	...
	constructor(props, context) {
	    ...
	    this.table.children['FilterBar'] = this;
	...
	drawFilterItem(){
		...
		for(let i in this.struct){
			...
			filterItems.push(
				<FilterItem ref={input=>this.filter_item[i] = input} colID={i} onChangeBlur={()=>this.onChangeBlurHandle()} key={i} struct = {this.struct[i]}/>
			)
		}
		return filterItems 
	}
