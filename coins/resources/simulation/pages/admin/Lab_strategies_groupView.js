...
class Lab_strategies_groupView extends Component {
    ...
    constructor(props) {
        ...
        this.model = new Lab_strategies()
        this.labAccountModel = new Lab_account()
    }
...
export default Lab_strategies_groupView;
