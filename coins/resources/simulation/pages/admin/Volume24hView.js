...
import VolumeAlertModal from '../../components/admin/VolumeAlertModal'
        ...
        for(let i in dates){
            ...
            if(dateData['result']){
                ...
                for(let j in dateData){
                    ...
                    tableData[sym][dates[i]] = data[CANDLE_24H_VOLUME_USDT];
                }
            }
        }
                        ...
                        left={<>
                            <div className='box_flex'>
                                ...
                                <Input className='input' placeholder='Start Time' ref={c => this.startDate = c} struct={{
                                    ...
                                    [INPUT_DEFAULT]: moment().subtract(3, 'days').format('DD/MM/YYYY'),
