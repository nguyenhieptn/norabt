...
class Lab_candle_1mView extends Component {
	...
	constructor(props) {
		...
		this.lab_candle_1m_struct[STRUCT_FILTERS] = {
			...
			[LAB_CANDLE_1M_TIME]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_TIME),
				[FILTER_TYPE]: 'date',
			...
			[LAB_CANDLE_1M_OPEN_TIME]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_OPEN_TIME),
				[FILTER_TYPE]: 'date',
				[FILTER_DECORATOR_IN]: (data) => { if (data == '') return data; else return moment(data, 'x').format(DATE_FORMAT) },
				[FILTER_DECORATOR_OUT]: (data) => { if (data == '') return data; else return moment(data, DATE_FORMAT).format('x') },
			},
			[LAB_CANDLE_1M_CLOSE_TIME]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_CLOSE_TIME),
				[FILTER_TYPE]: 'date',
				[FILTER_DECORATOR_IN]: (data) => { if (data == '') return data; else return moment(data, 'x').format(DATE_FORMAT) },
				[FILTER_DECORATOR_OUT]: (data) => { if (data == '') return data; else return moment(data, DATE_FORMAT).format('x') },
			},
			[LAB_CANDLE_1M_OPEN]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_OPEN),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_CLOSE]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_CLOSE),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_HIGH]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_HIGH),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_LOW]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_LOW),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_TRADES]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_TRADES),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_VOLUME]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_VOLUME),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_EMA5]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_EMA5),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_EMA9]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_EMA9),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_EMA12]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_EMA12),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_EMA13]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_EMA13),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_EMA26]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_EMA26),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_MACD]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_MACD),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_SIGNAL]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_SIGNAL),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_HISTOGRAM]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_HISTOGRAM),
				[FILTER_TYPE]: 'text',
			},
			[LAB_CANDLE_1M_STARTPOINT]: {
				[FILTER_NAME]: lang(LAB_CANDLE_1M_STARTPOINT),
				[FILTER_TYPE]: 'number',
			},
		...
		this.lab_candle_1m_struct[STRUCT_EDIT] = {
			...
			[LAB_CANDLE_1M_TIME]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_TIME),
				[EDIT_TYPE]: 'date',

			},
			[LAB_CANDLE_1M_SYMBOL]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_SYMBOL),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_OPEN_TIME]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_OPEN_TIME),
				[EDIT_TYPE]: 'date',

			},
			[LAB_CANDLE_1M_CLOSE_TIME]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_CLOSE_TIME),
				[EDIT_TYPE]: 'date',

			},
			[LAB_CANDLE_1M_OPEN]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_OPEN),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_CLOSE]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_CLOSE),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_HIGH]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_HIGH),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_LOW]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_LOW),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_TRADES]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_TRADES),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_VOLUME]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_VOLUME),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_EMA5]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_EMA5),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_EMA9]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_EMA9),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_EMA12]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_EMA12),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_EMA13]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_EMA13),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_EMA26]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_EMA26),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_MACD]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_MACD),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_SIGNAL]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_SIGNAL),
				[EDIT_TYPE]: 'text',

			},
			[LAB_CANDLE_1M_HISTOGRAM]: {
				[EDIT_NAME]: lang(LAB_CANDLE_1M_HISTOGRAM),
				[EDIT_TYPE]: 'text',
	...
	render() {
		return (
			<div>
				<Table ref={c => this.table = c} table={this.lab_candle_1m_struct} autoload={false}>
					<FuncBar
						left={<FuncHideCol />}
...
export default Lab_candle_1mView