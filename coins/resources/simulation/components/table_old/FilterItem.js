					...
					<>
						<div className={`filter_item ${this.props.className}`}>
							...
							<div className="filter_input">
								{this.logic.map(item => {
									return <Input key={item} ref={input => this.inputComps[item] = input} className="filter_item_input" struct={this.input_truct} onChange={this.onChangeBlur} {...this.rent}></Input>
								})}
							</div>
						</div>
					</>
				...
				return (
					<>
						<div className={`filter_item ${this.props.className}`}>
							...
							<div className="filter_input">
								{this.logic.map(item => {
									return <Input key={item} placeholder={lang(item)} ref={input => this.inputComps[item] = input} className="filter_item_input" struct={this.input_truct} onChange={this.onChangeBlur} {...this.rent}></Input>
								})}
							</div>
						</div>
					</>
					...
					<>
						<div className={`filter_item ${this.props.className}`}>
							...
							<div className="filter_input" style={{ position: 'relative', display: 'flex' }}>
								{this.logic.map(item => {
									return <Input placeholder={lang(item)} key={item} ref={input => this.inputComps[item] = input} className="filter_item_input" struct={this.input_truct} onChangeBlur={this.onChangeBlur} {...this.rent}></Input>
								})}
							</div>
						</div>
					</>
