...
import InputAce from './InputAce'
class Input extends Component {

	constructor(props) {
		super(props);
		this.oldValue = get(this.props.struct[INPUT_DEFAULT], '');
	...
	drawInput() {
		...
		switch (this.struct[INPUT_TYPE]) {
			...
			case "html":
				return (
					<InputHtml
						style={Object.assign({}, get(this.struct[INPUT_STYLE_INPUT], {}), { width: '100%', border: 'solid thin #eee', minHeight: 50 })}
						value={get(this.struct[INPUT_DEFAULT], '')}
						decoratorIn={get(this.struct[INPUT_DECORATOR_IN], null)}
						decoratorOut={get(this.struct[INPUT_DECORATOR_OUT], null)}
						id={this.id}
