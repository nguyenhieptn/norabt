...
class AccountStopLoss2Modal extends Component {
    ...
    constructor(props) {
        ...
        this.lab_order_struct[STRUCT_COLUMNS] = {
            ...
            'perT': {
                ...
                //     var blance = Number(data[rowId]['balance'])
                //     var blancePre = Number(data[rowId]['balancePre'])

                //     let a = ((blancePre - blance) / blance) * 100
                //     return a.toFixed(2) + '%'
                // }
    ...
    async loadOrigin() {
        ...
        // console.log(App.dataStopLossBalance2)
        // const result = App.dataStopLossBalance2.filter(item => {
        //     if(item['balance']){
        //         return true
        //     }
        //     return false
        // });
        let result = []
        App.dataStopLossBalance2.map(item => {
            if(item['balance']){
                var blance = Number(item['balance'])
                var blancePre = Number(item['balancePre'])
    
                let a = ((blancePre - blance) / blance) * 100
                item['perT'] = Number(a.toFixed(2)) 
...
export default AccountStopLoss2Modal