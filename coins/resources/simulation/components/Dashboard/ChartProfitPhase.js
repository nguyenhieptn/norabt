...
class ChartProfitPhase extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            if (res['data']) {
                ...
                Object.keys(data).map(strategy => {
                    ...
                    a.map(row => {
                        ...
                        var realProfit = row[LAB_RESULT_REAL_PNL];
                        if (!isset(strategyData[strategy][phase])) {
                            strategyData[strategy][phase] = realProfit;
                        } else {
                ...
                Object.keys(strategyData).map(strategy => {
                    ...
                    Object.keys(data).map(item => {
                        ...
                        dataColumn.push( Math.round(Number(data[item])*100)/100  );
...
export default ChartProfitPhase;