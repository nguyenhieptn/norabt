...
class ChartTotalOrderPerPhase extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default ChartTotalOrderPerPhase;