...
class ChartFlowSafe extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected: true,
            ...
            ChartOptions: {
                ...
                title: {
                    // text: '<b> Flow Safe</b>',
                    text: '<b> Flow NW-H50</b>',
                    // align: 'left',
                    // x: 60,
                    // y: 18
                },
                xAxis: {
                    // categories: ['4h-Safe', '1d-Safe'],
                    categories: ['4H-NW-H50', '1D-NW-H50'],
                },
                yAxis: {
    ...
    getData() {
        ...
        resultModel.getByAccount().then(res => {
            if (res['data']) {
                ...
                //     if (index > -1) {
                //         if (flow == '1D-Safe-LONG') {

                //             data1D[index] += 1;
                //         } else if (flow == '4H-Safe-LONG') {
                //             data4H[index] += 1;
                //         }
