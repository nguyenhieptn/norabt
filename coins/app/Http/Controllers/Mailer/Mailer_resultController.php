...
class Mailer_resultController extends Controller  
{

    function __construct()
    {
        parent::__construct();
        $this->mainModel = Models::get('Mailer/Mailer_result');
       
        
        $this->dependCols = array_unique(array_column($this->mainModel->registerDepend, 1, 1));
        $this->dependCols[MRESULT_ID] = true;
    ...
    public function mapping(){
        $mapData = [];
        $mapData[MRESULT_RESULT] = ['0'=>'Fail', '1'=>'Success'];
