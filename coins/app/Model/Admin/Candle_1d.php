...
class Candle_1d extends Model_basic
{
    function __construct()
    {
        ...
        $this->struct = array(
            ...
            CANDLE_1D_PRICE_WMA => [
                PROP_NAME => CANDLE_1D_PRICE_WMA,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1D_PRICE_WMA45 => [
                PROP_NAME => CANDLE_1D_PRICE_WMA45,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1D_RSI_WMA45 => [
                PROP_NAME => CANDLE_1D_RSI_WMA45,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1D_RSI_EMA9 => [
            ...
            CANDLE_1D_PRICE_EMA9 => [
                PROP_NAME => CANDLE_1D_PRICE_EMA9,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1D_NET_EMA9_WMA45 => [
                PROP_NAME => CANDLE_1D_NET_EMA9_WMA45,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
