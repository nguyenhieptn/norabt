...
class Candle_1h extends Model_basic
{
    function __construct()
    {
        ...
        $this->struct = array(
            ...
            CANDLE_1H_RSI_WMA45 => [
                PROP_NAME => CANDLE_1H_RSI_WMA45,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1H_PRICE_EMA9 => [
                PROP_NAME => CANDLE_1H_PRICE_EMA9,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1H_PRICE_WMA => [
                PROP_NAME => CANDLE_1H_PRICE_WMA,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1H_PRICE_WMA45 => [
                PROP_NAME => CANDLE_1H_PRICE_WMA45,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
            CANDLE_1H_NET_EMA9_WMA45 => [
                PROP_NAME => CANDLE_1H_NET_EMA9_WMA45,
                PROP_NULL => true,
                PROP_REGEX => "Pass",
            ],
