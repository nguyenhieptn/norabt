"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["./react/pages/admin-Lab_strategys_groupView-js"],{

/***/ "./resources/simulation/pages/admin/Lab_strategys_groupView.js":
/*!*********************************************************************!*\
  !*** ./resources/simulation/pages/admin/Lab_strategys_groupView.js ***!
  \*********************************************************************/
...
/* harmony import */ var _model_admin_Lab_account__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../model/admin/Lab_account */ "./resources/simulation/model/admin/Lab_account.js");
...
var Lab_strategys_groupView = /*#__PURE__*/function (_Component) {
  _inherits(Lab_strategys_groupView, _Component);

  var _super = _createSuper(Lab_strategys_groupView);

  function Lab_strategys_groupView(props) {
    var _this;

    _classCallCheck(this, Lab_strategys_groupView);

    _this = _super.call(this, props);
    _this.state = {
      group: {}
    };
    _this.model = new _model_admin_Lab_account__WEBPACK_IMPORTED_MODULE_2__.default();
    return _this;
  }

  _createClass(Lab_strategys_groupView, [{
  ...
  return Lab_strategys_groupView;
}(react__WEBPACK_IMPORTED_MODULE_1__.Component);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Lab_strategys_groupView);
...
var GroupFolder = /*#__PURE__*/function (_Component2) {
  ...
  function GroupFolder(props) {
    ...
    _this3.originName = _this3.props.name;
    return _this3;
  }
    ...
    value: function onBlur() {
      ...
      if (this.props.onChangeFolder) {
        this.props.onChangeFolder(this.state.name, this.originName).then(function (res) {
          if (!res['result']) {
            _this4.setState({
              name: _this4.originName
            });
          } else {
            _this4.originName = _this4.state.name;
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("img", {
          onClick: function onClick() {
            return _this5.props.onClick(_this5.state.name);
          },
